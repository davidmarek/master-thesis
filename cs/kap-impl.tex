...
Pole pak využívají implementaci z~knihovny Numpy, díky ní jsou matematické operace napsané v~rychlejším jazyku (C, Fortran) než je Python a jsou navíc vektorizované.
...
Implementace diskrétního faktoru obsahuje všechny základní matematické operace, ale operace určené speciálně pro pravděpodobnostní distribuce, např. marginalizace nebo normalizace.
